			...
			<div class="navigation_container">
				<div class="nav">
					<ul class="primary_nav">
						<li class="active highlight"><a href="index.jsp">水果</a></li>
				...
				<div id="side_nav">
					<div class="sideNavCategories">
						...
						<ul class="category departments">
							...
							<li><a href="goods_queryByName.action?gname=苹果">苹果</a></li>
							<li><a href="goods_queryByName.action?gname=香蕉">香蕉 </a></li>
							<li><a href="goods_queryByName.action?gname=橘子">橘子 </a></li>
							<li><a href="goods_queryByName.action?gname=菠萝">菠萝</a></li>
							<li><a href="goods_queryByName.action?gname=桃子">桃子</a></li>
							<li><a href="goods_queryByName.action?gname=草莓">草莓</a></li>
							<li><a href="goods_queryByName.action?gname=西瓜">西瓜 </a></li>
							<li><a href="goods_queryByName.action?gname=李子">李子 </a></li>
						</ul>
					</div>
